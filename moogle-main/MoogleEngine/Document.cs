...
///</summary>
   private int FillDictionarys(Dictionary<string, List<int>> dictionary, string textread, Dictionary<string, int> v)                  //textread: Contenido leido desde los Ficheros
   {
    
    var words= textread.Replace('\n', ' ')      // En words, las palabras separadas por espacio. Las palabras quedan sin acentos.
                ...
                .Replace('í', 'i')
                .Replace('ó', 'o')
                .Replace('ú', 'u').Trim().Split(" ",StringSplitOptions.RemoveEmptyEntries);
